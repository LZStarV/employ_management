 ...
 */
router.post('/batch-import', EmployeeController.importEmployees);
 ...
 *         description: 员工不存在
 */
router.put('/:id/adjust-salary', EmployeeController.adjustEmployeeSalary);
 ...
 *         description: 员工不存在
 */
router.put('/:id/resignation', EmployeeController.terminateEmployee);
